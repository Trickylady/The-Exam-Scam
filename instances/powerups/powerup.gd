...
const IMGS = {
	"Lives": preload("res://images/game/1up.png"),
	"Boosts": preload("res://images/game/adderall.png"),
	"Slows": preload("res://images/game/xanax.png"),
	"StackLives": preload("res://images/game/1upstack.png"),
	"StackBoosts": preload("res://images/game/adderallstack.png"),
	"StackSlows": preload("res://images/game/xanaxstack.png"),
}
