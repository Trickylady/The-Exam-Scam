...
func setup() -> void:
	...
	match bg_idx:
		0: %bg.texture = preload("res://images/game/paper_background.png")
		1: %bg.texture = preload("res://images/game/paper_background_2.png")
		2: %bg.texture = preload("res://images/game/paper_background_3.png")
